...
struct UpcomingEventData: Decodable {
    let status: String
    let message: String
    let data: [UpcomingEventDetails]
}

struct UpcomingEventDetails: Decodable {
...
class UpcomingTab: UIViewController, UITableViewDataSource, UITableViewDelegate  {
    ...
    func loadEventsData() {
        ...
        if preferences.string(forKey: "mainuserid") == nil && preferences.string(forKey: "yearID") == nil && preferences.string(forKey: "collegeID") == nil {
            ...
            //creating URLRequest
            let url = URL(string: "https://thomasianjourney.website/Register/insertUpcomingEvents")!
            ...
            data, response, error in
                ...
                if error != nil{
                    ...
                    do {
                        ...
                        let connection = try JSONDecoder().decode(UpcomingEventData.self, from: data)
